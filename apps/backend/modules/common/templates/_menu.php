<ul id="menu">
  <li><a href="<?php echo url_for('presta/index') ?>" target="_self" title="Presta" class="current">Prestas</a></li>
  ...
  <li><a href="<?php echo url_for('commentAdmin/index'); ?>" target="_self" title="Localities">Comments</a></li>
  <li><a href="<?php echo url_for('commentReportAdmin/index'); ?>" target="_self" title="Localities">Reported comments</a></li>
</ul>
