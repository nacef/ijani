...
/**
 * PrestaRating form base class.
 *
 * @method PrestaRating getObject() Returns the current form's model object
 *
 * @package    ijani
 * @subpackage form
 ...
 */
abstract class BasePrestaRatingForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('presta_rating[%s]');
